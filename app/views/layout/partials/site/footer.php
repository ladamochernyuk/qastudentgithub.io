...
<div class="modal" id="login">
    <div class="dialog">
        <a href="#close" title="close-dialoge" class="close">X</a>
        <div class="col-left">
            <div class="login-text">
                <h2>Welcome back</h2>
                <p>Create your account,<br>Its totally free</p>
            ...
            <div class="col-right">
                <div class="login-form">
                    ...
                    <form method="POST" action="/login"> 
                        <p>
                            <label>Username or email adress<span>*</span></label>
                            <input type="email" name="email" placeholder="Username or email adress" require>
                        </p>
                        <p>
